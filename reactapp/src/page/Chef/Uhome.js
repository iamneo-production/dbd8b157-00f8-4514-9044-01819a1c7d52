...
import '../../css-components/Uhome.css';
...
function Uhome() {
  ...
  return (
    <>
    <div className="bodyyyc">
        <header class="headerc">
        <nav className="uhomenav">
        <div className="log22"></div>
            <div>
                <ul id="navbarc">
                    <Link to="/Editc"><li><a className="active" href="#"><Button className='button31b'><img src={add} alt="my" width={"35px"} /><h1 className="editccc">ADD DETAILS</h1></Button></a></li></Link>
                    <Link to="/view"><li><a href="#"><Button className='button31b'><img src={edit} alt="my" width={"35px"} /><h1 className="editccc">VIEW DETAILS</h1></Button></a></li></Link>
                    <Link to="/Editd"><li><a href="#"><Button className='button31b'><img src={view} alt="my" width={"35px"} /><h1 className="editccc">EDIT DETAILS</h1></Button></a></li></Link>
      ...
      >
        ...
        <main>
        <div class="introc">
        <h1 className="des1">CHEF FINDER</h1>
